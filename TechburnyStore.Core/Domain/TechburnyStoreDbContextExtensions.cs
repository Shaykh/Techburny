...
{
    public static class TechburnyStoreDbContextExtensions
    {
        public static void Add<TEntity>(this TechburnyStoreDbContext dbContext, TEntity entity, IUserInfo userInfo) where TEntity : class, IAuditableEntity
        {
        ...
        public static void Update<TEntity>(this TechburnyStoreDbContext dbContext, TEntity entity, IUserInfo userInfo) where TEntity : class, IAuditableEntity
        {
            if (entity is IAuditableEntity cast)
            {
        ...
        public static void Remove<TEntity>(this TechburnyStoreDbContext dbContext, TEntity entity) where TEntity : class, IAuditableEntity
            => dbContext.Set<TEntity>().Remove(entity);

        private static IEnumerable<ChangeLog> GetChanges(this TechburnyStoreDbContext dbContext, IUserInfo userInfo)
        {
