...
{
    public static class TechburnyStoreDbContextQueries
    {
        public static async Task<Employee> GetEmployeeAsync(this TechburnyStoreDbContext dbContext, Employee entity)
            => await dbContext.Employees.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static IQueryable<Product> GetProducts(this TechburnyStoreDbContext dbContext, int? productCategoryID = null)
        {
        ...
        public static async Task<Product> GetProductAsync(this TechburnyStoreDbContext dbContext, Product entity)
            => await dbContext.Products.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static Product GetProductByName(this TechburnyStoreDbContext dbContext, string productName)
            => dbContext.Products.FirstOrDefault(item => item.ProductName == productName);

        public static async Task<ProductCategory> GetProductCategoryAsync(this TechburnyStoreDbContext dbContext, ProductCategory entity)
            => await dbContext.ProductCategories.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static IQueryable<ProductInventory> GetProductInventories(this TechburnyStoreDbContext dbContext, int? productID = null, string locationID = null)
        {
        ...
        public static async Task<ProductInventory> GetProductInventoryAsync(this TechburnyStoreDbContext dbContext, ProductInventory entity)
            => await dbContext.ProductInventories.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static async Task<Location> GetLocationAsync(this TechburnyStoreDbContext dbContext, Location entity)
            => await dbContext.Locations.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static async Task<OrderStatus> GetOrderStatusAsync(this TechburnyStoreDbContext dbContext, OrderStatus entity)
           => await dbContext.OrderStatuses.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static async Task<Customer> GetCustomerAsync(this TechburnyStoreDbContext dbContext, Customer entity)
            => await dbContext.Customers.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static async Task<Shipper> GetShipperAsync(this TechburnyStoreDbContext dbContext, Shipper entity)
            => await dbContext.Shippers.FirstOrDefaultAsync(item => item.ID == entity.ID);

        public static IQueryable<OrderInfo> GetOrders(this TechburnyStoreDbContext dbContext, short? orderStatusID = null, int? customerID = null, int? employeeID = null, int? shipperID = null, string currencyID = null, Guid? paymentMethodID = null)
        {
        ...
        public static async Task<OrderHeader> GetOrderAsync(this TechburnyStoreDbContext dbContext, OrderHeader entity)
